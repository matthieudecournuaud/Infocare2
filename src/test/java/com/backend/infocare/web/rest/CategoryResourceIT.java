...
import static com.backend.infocare.domain.CategoryAsserts.*;
...
import com.backend.infocare.domain.Category;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).icon(DEFAULT_ICON);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).icon(UPDATED_ICON);
        return category;
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).icon(UPDATED_ICON);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.icon(UPDATED_ICON);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).icon(UPDATED_ICON);
