...
/**
 * REST controller for managing {@link com.backend.infocare.domain.Comment}.
 */
@RestController
        ...
        Optional<Comment> result = commentRepository
            ...
            .map(existingComment -> {
                ...
                if (comment.getVisibility() != null) {
                    existingComment.setVisibility(comment.getVisibility());
                }
                if (comment.getDescription() != null) {
                    existingComment.setDescription(comment.getDescription());
                }
                if (comment.getEditedBy() != null) {
                    existingComment.setEditedBy(comment.getEditedBy());
                }
                if (comment.getEditedAt() != null) {
                    existingComment.setEditedAt(comment.getEditedAt());
                }
                if (comment.getAttachments() != null) {
                    existingComment.setAttachments(comment.getAttachments());
                }
                if (comment.getResponseToCommentId() != null) {
                    existingComment.setResponseToCommentId(comment.getResponseToCommentId());
                }
