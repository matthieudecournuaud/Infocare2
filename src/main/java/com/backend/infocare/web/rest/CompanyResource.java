...
/**
 * REST controller for managing {@link com.backend.infocare.domain.Company}.
 */
@RestController
    ...
    public ResponseEntity<Company> partialUpdateCompany(
        ...
        Optional<Company> result = companyRepository
            ...
            .map(existingCompany -> {
                ...
                if (company.getContactPersonPhone() != null) {
                    existingCompany.setContactPersonPhone(company.getContactPersonPhone());
                }
                if (company.getContactPersonEmail() != null) {
                    existingCompany.setContactPersonEmail(company.getContactPersonEmail());
                }
