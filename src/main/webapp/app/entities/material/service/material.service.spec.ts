...
const requireRestSample: RestMaterial = {
  ...
  warrantyEndDate: sampleWithRequiredData.warrantyEndDate?.format(DATE_FORMAT),
  lastMaintenanceDate: sampleWithRequiredData.lastMaintenanceDate?.format(DATE_FORMAT),
};
