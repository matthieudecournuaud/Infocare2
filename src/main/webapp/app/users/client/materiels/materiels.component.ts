...
import { IMaterial } from '../../../entities/material/material.model';
import { EntityArrayResponseType, MaterialService } from '../../../entities/material/service/material.service';
import { MaterialDeleteDialogComponent } from '../../../entities/material/delete/material-delete-dialog.component';
...
export default class MaterielsComponent implements OnInit {
  materials?: IMaterial[];
  isLoading = false;
