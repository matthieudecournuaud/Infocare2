...
import { EntityArrayResponseType, TicketService } from '../../../entities/ticket/service/ticket.service';
import { TicketDeleteDialogComponent } from '../../../entities/ticket/delete/ticket-delete-dialog.component';
...
export default class MesTicketsComponent implements OnInit {
  tickets?: ITicket[];
  isLoading = false;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tickets = this.refineData(dataFromBody);
  }

  protected refineData(data: ITicket[]): ITicket[] {
